	...
	<table class="mainTable" cellpadding="0" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td><?=$settings['indentUnit_input']?></td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td><?=$settings['indentWithTabs_input']?></td>
			</tr>
			<tr>
				<td>
				...
				<td><?=$settings['electricChars_bool']?></td>
			</tr>
			<tr>
				<td>
				...
				<td><?=$settings['autoClearEmptyLines_bool']?></td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td><?=$settings['lineWrapping_bool']?></td>
			</tr>
			<tr>
				<td>
				...
				<td><?=$settings['lineNumbers_bool']?></td>
			</tr>
			<tr>
				<td>
				...
				<td><?=$settings['firstLineNumber_input']?></td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td><?=$settings['fixedGutter_bool']?></td>
			</tr>
			<tr>
				<td>
				...
				<td><?=$settings['matchBrackets_bool']?></td>
			</tr>
			<tr>
				<td>
				...
				<td><?=$settings['pollInterval_input']?></td>
			</tr>
			<tr>
				<td>
				...
				<td><?=$settings['undoDepth_input']?></td>
			</tr>
		</tbody>
	</table>
